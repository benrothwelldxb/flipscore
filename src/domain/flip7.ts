...
export function scoreFlip7(selection: Flip7Selection): Flip7Result {
  ...
  const isFlip7 = unique.length >= FLIP7_COUNT
  ...
  if (isFlip7) {
    breakdown.push({ label: 'Flip 7 bonus', value: FLIP7_BONUS })
  }
