 ...
 * the Durable Object that owns that room; every other request is served from
 * the static asset bundle (the built SPA), so client-side routing keeps working
 * via the assets binding's single-page-application fallback.
 */
export default {
